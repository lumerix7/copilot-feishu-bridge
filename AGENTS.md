...
- Build: `npm run build`
- There is currently no `npm test` script in this repo; validate behavior with targeted manual checks in Feishu DM plus local `/status`, `/new`, `/resume`, `/model`, `/project`, and wrapped local-command flows.
